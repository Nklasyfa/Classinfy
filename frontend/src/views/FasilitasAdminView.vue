...
<template>
  <div class="font-body text-on-background min-h-screen relative overflow-x-hidden bg-background">
    ...
    <div class="fixed top-40 -right-12 w-48 h-48 bg-secondary/5 blur-3xl rounded-full pointer-events-none"></div>
    <div class="fixed bottom-20 -left-12 w-64 h-64 bg-primary/5 blur-3xl rounded-full pointer-events-none"></div>

    <!-- TopNavBar -->
     <nav class="fixed top-4 left-1/2 -translate-x-1/2 w-[900px] max-w-[95%] rounded-full flex items-center justify-between px-6 py-2 z-40 shadow-[0_8px_32px_rgba(26,60,110,0.06)] bg-white/80 backdrop-blur-[20px]">
      <div class="flex items-center gap-8">
        <span class="text-2xl font-extrabold text-blue-900 tracking-tight">CLASSINFY</span>
        <div class="hidden md:flex items-center gap-1">
          ...
          <router-link to="/admin/fasilitas" class="bg-blue-900 text-white rounded-full px-4 py-1.5 text-sm font-medium cursor-pointer shadow-sm">Fasilitas</router-link>
