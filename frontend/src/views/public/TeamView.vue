        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          <div v-for="(member, index) in teamMembers" :key="index" class="flex flex-col">
            ...
            <div class="flex items-center gap-4 mt-auto">
              <!-- LinkedIn Icon (Using SVG as there is no good material symbol for social) -->
              <a :href="member.linkedin" target="_blank" class="text-on-surface-variant hover:text-primary transition-colors">
